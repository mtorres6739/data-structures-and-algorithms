...
public class RepeatedWordTest {
  ...
  public void  repeatedWord() throws UnsupportedEncodingException {
    RepeatedWord testForRepeatedWord = new RepeatedWord();
    ...
    assertEquals("First word to repeat should be a", "a", testForRepeatedWord.repeatedWord(testString));
  }
  ...
  public void repeatedWord3() throws UnsupportedEncodingException {
    ...
    assertEquals("First word to repeat should be the", "the", testForRepeatedWord.repeatedWord(testString));
  }

  @Test
  public void repeatedWord4() throws UnsupportedEncodingException {
    RepeatedWord testForRepeatedWord = new RepeatedWord();
    String testString = "we were all going direct the other way – in short...";
    assertEquals("There should not be any repeated words", null, testForRepeatedWord.repeatedWord(testString));
  }
}
